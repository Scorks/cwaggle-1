...
class ConfigEditor:
    ...
    def writeNewFile(self):
        ...
        self.file.write(self.getSpacing('numPucks', '200'))
        ...
        self.file.write(self.getSpacing('outieThreshold', '1'))
        self.file.write(self.getSpacing('innieThreshold', '1'))
        ...
        self.file.write(self.getSpacing('importGrid', '1 images/potential_field_Z.png'))
        self.file.close()

    def writeNewFileRL(self, hashFunction):
        if (hashFunction == 'Original'):
            self.file = open(self.fileName, "r+")
            self.file.truncate()
            self.file.write(self.getSpacing('width', '800'))
            self.file.write(self.getSpacing('height', '800'))
            self.file.write(self.getSpacing('numRobots', '8'))
            self.file.write(self.getSpacing('robotRadius', '10'))
            self.file.write(self.getSpacing('gui', '1'))
            self.file.write(self.getSpacing('numPucks', '200'))
            self.file.write(self.getSpacing('puckRadius', '10'))
            ...
            self.file.write(self.getSpacing('hashFunction', 'Original'))
            self.file.write(self.getSpacing('actions', '4 0.3 0.15 -0.15 -0.3'))
            self.file.write(self.getSpacing('maxTimeSteps', '5000000'))
            self.file.write(self.getSpacing('batchSize', '1'))
            self.file.write(self.getSpacing('initialQ', '1.0'))
            self.file.write(self.getSpacing('alpha', '0.2'))
            self.file.write(self.getSpacing('gamma', '0.9'))
            ...
            self.file.write(self.getSpacing('plotFilename', 'gnuplot/1.txt'))
            self.file.write(self.getSpacing('qLearning', '1'))
            self.file.write(self.getSpacing('savePolicy', '0 gnuplot/q_out.txt'))
            self.file.write(self.getSpacing('loadPolicy', '0 gnuplot/q_out.txt'))
            self.file.write(self.getSpacing('resultsDir', 'results/stateRepTests/'))
            self.file.write(self.getSpacing('RLAction', '1'))
            self.file.write(self.getSpacing('importGrid', '0 images/potential_field_Z.png'))
            self.file.close()
        elif (hashFunction == 'PuckMid4'):
            self.file = open(self.fileName, "r+")
            self.file.truncate()
            self.file.write(self.getSpacing('width', '800'))
            self.file.write(self.getSpacing('height', '800'))
            ...
            self.file.write(self.getSpacing('outieThreshold', '0.6'))
            self.file.write(self.getSpacing('innieThreshold', '0.8'))
            self.file.write(self.getSpacing('hashFunction', 'PuckMid4'))
            self.file.write(self.getSpacing('actions', '4 0.3 0.15 -0.15 -0.3'))
            self.file.write(self.getSpacing('maxTimeSteps', '5000000'))
            self.file.write(self.getSpacing('batchSize', '1'))
            self.file.write(self.getSpacing('initialQ', '1.0'))
            ...
            self.file.write(self.getSpacing('outieThreshold', '0.6'))
            self.file.write(self.getSpacing('innieThreshold', '0.8'))
            self.file.write(self.getSpacing('hashFunction', 'PuckMid16'))
            self.file.write(self.getSpacing('actions', '4 0.3 0.15 -0.15 -0.3'))
            self.file.write(self.getSpacing('maxTimeSteps', '5000000'))
            self.file.write(self.getSpacing('batchSize', '1'))
            self.file.write(self.getSpacing('initialQ', '1.0'))
